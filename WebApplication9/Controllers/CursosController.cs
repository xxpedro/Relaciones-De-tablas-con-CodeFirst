...
namespace WebApplication9.Controllers
{
    public class CursosController : Controller
    {
        ...
        public CursosController(EscuelitaTablas context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("idCursos,Nombre")] Cursos cursos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idCursos,Nombre")] Cursos cursos)
        {
        ...
        {
            return _context.Cursos.Any(e => e.idCursos == id);
        }
    }
}
